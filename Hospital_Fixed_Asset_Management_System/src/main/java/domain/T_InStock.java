...
public class T_InStock {
    ...
    public T_InStockDtl getBillNo() {
		return billNo;
	}

	public void setBillNo(T_InStockDtl billNo) {
		this.billNo = billNo;
	}
	...
	public void setBillNO4(String billNO4) {
		this.billNO4 = billNO4;
	}
}